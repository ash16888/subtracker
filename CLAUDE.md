...
- Анализ подписок с помощью искусственного интеллекта
- Генерация персонализированных рекомендаций
- Визуализация потенциальной экономии

**Типы инсайтов:**
- **Оптимизация:** Рекомендации по переходу на годовые тарифы
- **Дубликаты:** Выявление сервисов с похожей функциональностью
- **Предупреждения о расходах:** Алерты о дорогих подписках
- **Тренды:** Анализ общих расходов и паттернов
- **Прогнозы:** Предсказание будущих расходов
- **Анализ категорий:** Рекомендации по категориям подписок

**Особенности реализации:**
- Симуляция AI анализа на клиенте (для демо)
- Подготовлена интеграция с AI API через Supabase Edge Functions
- Кэширование результатов для экономии API вызовов
- Фильтрация инсайтов по типам
- Индикация приоритета (высокий/средний/низкий)
- **Демо-режим без авторизации** (/demo) с тестовыми данными
- Интеграция с главной страницей логина
